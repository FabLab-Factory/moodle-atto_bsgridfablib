 ...
 */
function atto_bsgridfablib_strings_for_js() {
    global $PAGE;
 ...
 */
function atto_bsgridfablib_params_for_js($elementid, $options, $fpoptions) {
    // Get config
    $config = get_config('atto_bsgridfablib', 'enabled_templates');
